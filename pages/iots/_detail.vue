...
<div v-if="iot">
    ...
    <section>
        <div class="app-min-width grid">
            ...
            <div class="accordion">
                ...
                <div class="body">
                    <ul>
                        <li v-for="(meta, index) in JSON.parse(iot.metadata)" :key="index">
    ...
    <section class="drone" v-if="iot.images.length > 0">
        <div class="app-min-width">
            <div class="accordion">
                <div class="head">
                ...
                <div class="body">
                    <div class="images">
                        <img v-for="image in iot.images" :key="image.id" :src="'https://agoralease.herokuapp.com/storage/' + image.url" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="app-min-width">
            ...
            <div class="activities" v-if="iot.offers.length > 0">
                <div class="activity" v-for="offer in iot.offers" :key="offer.id">
...
<Loading v-else :message="'Fetching iot'" />
</template>
...
export default {
    ...
    methods: {
        getIot() {
            const url = 'get/iot?id=' + this.$route.params.detail
            ...
            this.$axios.get(url).then((response) => {
                ...
                if (data.status) {
                    ...
                    if (this.$auth.loggedIn && this.iot.user_id == this.$auth.user.id) {
                        this.author = true
                    }
        ...
        promptCreateOffer() {
            ...
            this.newOffer = {
                ...
                image: this.iot.images.length > 0 ? 'https://agoralease.herokuapp.com/' + this.iot.images[0].url : '/iot.ong',
        ...
        accept(offer) {
            ...
            const url = 'accept/user/offer?id=' + this.iot.id +
                '&offer_id=' + offer.id;
