    ...
    <section class="drone" v-if="land.images.length > 0">
        <div class="app-min-width">
            <div class="accordion">
                ...
                <div class="body">
                    <div class="images">
                        <img v-for="image in land.images" :key="image.id" :src="'https://agoralease.herokuapp.com/storage/' + image.url" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    methods: {
        ...
        promptCreateOffer() {
            ...
            this.newOffer = {
                ...
                image: this.land.images.length > 0 ? 'https://agoralease.herokuapp.com/' + this.land.images[0].url : '/land.ong',
